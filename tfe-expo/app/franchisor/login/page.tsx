...
export default function FranchisorLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-6 py-16">
      <main className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <p className="text-sm font-semibold text-amber-600">The Franchise Edge</p>
        <h1 className="mt-1 text-2xl font-semibold text-slate-900">Franchisor Portal</h1>
        <p className="mt-2 text-sm text-slate-500">
          Sign in to manage your brand listing and view leads.
        </p>
